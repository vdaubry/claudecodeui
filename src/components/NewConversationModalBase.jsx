/*
 * NewConversationModalBase.jsx - Shared modal for creating new conversations
 *
...
export default function NewConversationModalBase({
  isOpen,
  onClose,
  project,
  entity,
  ...
  const projectPath = adapter?.getProjectPath
    ...
    : (project?.repo_folder_path || project?.path);
  ...
  }, [adapter, entity, entityId, input, isSending, logTag, onConversationCreated, permissionMode, projectPath]);
